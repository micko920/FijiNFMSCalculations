...
test_that("Baseline Data example", {
  expect_equal(CalcEmForPlantHW(62199.55, BiomassConvExpansionHW, RootToShootTropRain), 154193.617)
})

test_that("Baseline Data example", {
  expect_equal(CalcEmForPlantHW(1, BiomassConvExpansionHW, RootToShootTropRain), 2.479015)
})

test_that("zeros", {
  expect_equal(CalcEmForPlantHW(0, BiomassConvExpansionHW, RootToShootTropRain), 0)
})

test_that("negative numbers", {
  expect_equal(CalcEmForPlantHW(-0.1, BiomassConvExpansionHW, RootToShootTropRain), -0.2479015)
})
