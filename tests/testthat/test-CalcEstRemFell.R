...
test_that("Baseline FRL example", {
  expect_equal(CalcEstRemFell(11669.87, 0.99), -42361.6281)
})

test_that("Baseline Data example", {
  expect_equal(CalcEstRemFell(1, MAICFell), -3.63)
})

test_that("Baseline Data example", {
  expect_equal(CalcEstRemFell(1, 1), (-44 / 12))
})

test_that("Baseline Data example", {
  expect_equal(CalcEstRemFell((1 / 3), 1), (-44 / 36))
})


test_that("Zeros", {
  expect_equal(CalcEstRemFell(0, MAICFell), 0)
})
